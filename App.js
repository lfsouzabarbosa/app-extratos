...
apiTK.get('/', (req, res) => { 
  ...
  (async () => {
      ...
      await page.waitForSelector('input[name=grupo]', grupo, { delay: 1000 }); // '4830'
      await page.waitForSelector('input[name=cota]', cota, { delay: 1000 }); // '23'
      await page.waitForSelector('input[name=inscricaoNacional]', documento, { delay: 1000 }); // '51941163653'
      await page.waitForSelector('input[name=numeroContrato]', contrato, { delay: 1000 }); // '109242563'
